...
public class MusicBoxManager : MonoBehaviour
{
    ...
    {
        MusicNumText.color = new Color(0.8f, 0.8f, 0.8f);
        MusicNameText.color = new Color(0.8f, 0.8f, 0.8f);
        NoteImage.color = new Color(0.8f, 0.8f, 0.8f);
    }
    public void SetUnPressedButton()
    {
        MusicNumText.color = new Color(1, 1, 1);
        MusicNameText.color = new Color(1, 1, 1);
        NoteImage.color = new Color(1, 1, 1);
    }
